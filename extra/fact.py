...
def text_messages_to_string(mes):
    ...
    output = ''
    var1 = "\"#"
    for i in range(1,math.trunc(len(mes)*(1/2)+1)):
        if mes[i*2-2].get_content_type().startswith('text'):
            output += var1 + str(i) + str(mes[i*2-2])
    return output
...
to_file(text_messages_to_string(extract_mbox_file('C:/Users/hp/Desktop/Fact/factTextBase/engaging/Unread.mbox')), 'C:/Users/hp/Desktop/Fact/factTextBase/engaging/extracted.txt')
